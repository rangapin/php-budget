            ...
            <div class="col-xs-6 col-md-3">
               <div class="panel">
                  <?php
                     ...
                     {echo "0";} else {echo $sum_yesterday_expense;}
            ...
            <div class="col-xs-6 col-md-3">
               <div class="panel">
                  <?php
                     ...
                     $query_two=mysqli_query($con,"SELECT sum(cost) AS weeklyExpense FROM expense WHERE ((theDate) BETWEEN '$week_date' AND '$current_date') && (UserId='$userid');");
                     $result_two=mysqli_fetch_array($query_two);
                     $sum_weekly_expense=$result_two['weeklyExpense'];
                      ?>
                  <div class="easypiechart-panel">
                     <h4>Last 7 days</h4>
                     <div class="easypiechart" id="easypiechart-green" data-percent="<?php echo $sum_weekly_expense;?>"><span class="percent"><?php if($sum_weekly_expense=="")
                     {echo "0";} else {echo $sum_weekly_expense;}
            ...
            <div class="col-xs-6 col-md-3">
               <div class="panel">
                  ...
                  <div class="easypiechart-panel">
                     ...
                     {echo "0";} else {echo $sum_monthly_expense;}
         ...
         <div class="final-chart">
            <div class="col-xs-6 col-md-3">
               <div class="panel">
                  ...
                  <div class="easypiechart-panel">
                     <h4>This Year</h4>
                     <div class="easypiechart" id="easypiechart-yello" data-percent="<?php echo $sum_yearly_expense;?>" ><span class="percent"><?php if($sum_yearly_expense=="")
                     {echo "0";} else {echo $sum_yearly_expense;}
            ...
            <div class="col-xs-6 col-md-3">
               <div class="panel">
                  ...
                  <div class="easypiechart-panel">
                     <h4>Total</h4>
                     <div class="easypiechart" id="easypiechart-purple" data-percent="<?php echo $sum_total_expense;?>" ><span class="percent"><?php if($sum_total_expense=="")
                     {echo "0";} else {echo $sum_total_expense;}
